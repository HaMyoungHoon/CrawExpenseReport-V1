...
namespace CrawExpenseReport.Screen
{
    public class PageLoginSettingViewModel : INotifyPropertyChanged
    {
        ...
        public bool IsHotReload
        {
            ...
            set
            {
                if (_isHotReload != value)
                {
                    _isHotReload = value;
                    OnPropertyChanged();
                    FBaseFunc.Ins.Cfg.SetHotReload(value);
                }
            }
        }
        public bool IsNewFirst
        {
            ...
            set
            {
                if (_isNewFirst != value)
                {
                    _isNewFirst = value;
                    OnPropertyChanged();
                    FBaseFunc.Ins.Cfg.SetIsNewFirst(value);
                }
            }
        }
        public bool IsDirectInput
        {
            ...
            set
            {
                if (_isDirectInput != value)
                {
                    _isDirectInput = value;
                    OnPropertyChanged();
                    FBaseFunc.Ins.Cfg.SetIsDirectInput(value);
                }
            }
        }
        ...
        public bool IsSpeedUp
        {
            ...
            set
            {
                if (_isSpeedUp != value)
                {
                    _isSpeedUp = value;
                    OnPropertyChanged();
                    FBaseFunc.Ins.Cfg.SetIsSpeedUp(value);
                }
            }
        }
        ...
        {
            WindowMessageBoxDialog messageBoxDialog = new WindowMessageBoxDialog("경고경고", "서버로부터 유효성검사 목록을 다시 받습니다.\n계속 하시겠습니까?", true);
        ...
        public void Reload()
        {
            ...
            IsHotReload = FBaseFunc.Ins.Cfg.IsHotReload;
            IsNewFirst = FBaseFunc.Ins.Cfg.IsNewFirst;
            IsDirectInput = FBaseFunc.Ins.Cfg.IsDirectInput;
            IsSuccessLogHide = FBaseFunc.Ins.Cfg.IsSuccessLogHide;
            IsSpeedUp = FBaseFunc.Ins.Cfg.IsSpeedUp;
