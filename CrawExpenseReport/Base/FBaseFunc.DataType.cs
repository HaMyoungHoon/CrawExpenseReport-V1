...
namespace CrawExpenseReport.Base
{
    public partial class FBaseFunc
    {
        ...
        public class CompanyModel : ICloneable
        {
            ...
            {
                CompanyModel buff = JsonSerializer.Deserialize<CompanyModel>(data.ToString(), null);
        ...
        public class WorkplaceModel : ICloneable
        {
            ...
            {
                WorkplaceModel buff = JsonSerializer.Deserialize<WorkplaceModel>(data.ToString(), null);
                CompanyCode     = buff.CompanyCode;
        ...
        public class AccountModel : ICloneable
        {
            ...
            {
                AccountModel buff = JsonSerializer.Deserialize<AccountModel>(data.ToString(), null);
                CompanyCode     = buff.CompanyCode;
        ...
        public class CorrespondentModel : ICloneable
        {
            ...
            {
                CorrespondentModel buff = JsonSerializer.Deserialize<CorrespondentModel>(data.ToString(), null);
                CompanyCode         = buff.CompanyCode;
        ...
        public class DepartmentModel : ICloneable
        {
            ...
            {
                DepartmentModel buff = JsonSerializer.Deserialize<DepartmentModel>(data.ToString(), null);
                CompanyCode     = buff.CompanyCode;
                WorkplaceCode   = buff.WorkplaceCode;
