...
namespace CrawExpenseReport.Base
{
    public partial class FBaseConfig
    {
        ...
        private const string CopyPath = "CopyCfg.xml";
        private const string CopyListPath = "CopyList.xml";
        ...
        public bool IsNewFirst { get; set; }
        public bool IsDirectInput { get; set; }
